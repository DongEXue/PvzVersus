...
// attention! this is not a test, u will see amount of variables here, but they are all working
...
IMAGE img_selector_tip;;						//选择角色提示图片
IMAGE img_selector_background;					//选择角色背景图片
...
IMAGE img_peashooter_selector_background_left;	//选择豌豆射手左朝向的背景图片
IMAGE img_peashooter_selector_background_right;	//选择豌豆射手右朝向的背景图片
IMAGE img_sunflower_selector_background_left;	//选择向日葵左朝向的背景图片
IMAGE img_sunflower_selector_background_right;	//选择向日葵右朝向的背景图片

IMAGE img_sky;									//天空图片
IMAGE img_hills;								//小山图片
...
Atlas atlas_peashooter_attack_ex_left;			//豌豆射手朝向左的攻击动画图集
Atlas atlas_peashooter_attack_ex_right;			//豌豆射手朝向右的攻击动画图集
...
Atlas atlas_sunflower_attack_ex_left;			//向日葵朝向左的攻击动画图集
Atlas atlas_sunflower_attack_ex_right;			//向日葵朝向右的攻击动画图集
Atlas atlas_sunflower_die_left;					//向日葵朝向左的死亡动画图集
Atlas atlas_sunflower_die_right;				//向日葵朝向右的死亡动画图集

IMAGE img_pea;									//豌豆子弹图片		
Atlas atlas_pea_break;							//豌豆子弹破碎效果动画图集
Atlas atlas_sun;								//阳光图片
Atlas atlas_sun_explode;						//阳光爆炸效果动画图集
Atlas atlas_sun_ex;								//特殊阳光效果动画图集
Atlas atlas_sun_ex_explode;						//特殊阳光爆炸效果动画图集
Atlas atlas_sun_text;							//“日”文本图片动画图集

Atlas atlas_run_effect;							//奔跑效果动画图集
...
void load_game_resources() {
	...
	loadimage(&img_gravestone_left, _T("resources/gravestone_left.png"));
...
int main(void) {
	...
	while (1) {
		...
		current_tick_time = last_tick_time;
